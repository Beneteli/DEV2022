...
let cat = {
  ...
  age: 10,
  color: 'branco',
  bestFriends: ['Cremilda', 'Gertrudes'],
  sound: function ()  {
    return 'Miaau'}
  }
...
let addFriend = friendCat => cat.bestFriends.push(friendCat)
...
let booleanReturn = itsObject => typeof itsObject == 'object'

//console.log (booleanReturn (cat))
...
let dog = {
  ...
  age: 6,
  color: 'marrom',
  bestFriends: ['Juliana', 'Alice'],
  sound: () => 'Au Au'
}

let somaAge = function () {
  let somaAges = cat.age + dog.age
  return console.log(`A soma das idades de ${cat.name} e ${dog.name} é ${somaAges} anos`)
}
